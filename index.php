...
<body>
            ...
            <div class="row grids-wthree-info text-center">
                <div class="col-lg-4 ab-content">
                    <div class="ab-info-con">
                        ...
                        <p>Siparişleriniz 1 İş Günü İçerisinde Kargoya Verilir</p>
                    </div>
                </div>
                <div class="col-lg-4 ab-content">
                    <div class="ab-info-con">
                        <h4>Güvenli Ödeme</h4>
                        <p>Kredi Kartı Bilgileriniz Serverlarımızda Tutulmaz</p>
                    </div>
                </div>
                <div class="col-lg-4 ab-content">
                    <div class="ab-info-con">
                        <h4>%100 Para İade Garantisi</h4>
                        <p>Herhangi Bir Sıkıntıda Para İade Garantisi</p>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4 ab-content text-center p-lg-5 p-3 my-lg-5">
                    <h4>Seyahatler Sizin İçin Önemliyse</h4>
                    <p>Seyahatlerinizde Sizi Rahat Ettirecek Bir Çanta İstiyorsanız Doğru Yerdesiniz</p>
    ...
    <section class="banner-bottom py-5">
        <div class="container py-md-5">
            ...
            <h3 class="title-wthree mb-lg-5 mb-4 text-center">Koleksiyonlar </h3>
            <div class="row text-center">
                ...
                <div class="col-md-4 content-gd-wthree ab-content py-lg-5 my-lg-5">
                    <h4>Exstra Alana Mı İhtiyacınız Var ?</h4>
                    <p>Geniş Alanı İle Sizlere Rahatlık Sağlayacak Çanta İçin Doğru Yerdesiniz</p>
        ...
        <div class="d-lg-flex p-0">
            <div class="col-lg-6 bottom-w3pvt-left p-lg-0">
                ...
                <div class="pos-wthree">
                    <h4 class="text-wthree">Kadın Çantalarında<br> %50'ye Varan İndirimler</h4>
                    <a href="shop.php" class="btn shop mt-3">Alışverşe Başla</a>
                </div>
            </div>
            <div class="col-lg-6 bottom-w3pvt-left bottom-w3pvt-right p-lg-0">
                <img src="images/ab2.jpg" class="img-fluid" alt="" />
                <div class="pos-w3pvt">
                    <h4 class="text-w3pvt">Erkek Çantalarında <br> %30'a Varan İndirimler</h4>
                    <a href="shop.php" class="btn shop mt-3">Alışverşe Başla</a>
                </div>
            </div>
        </div>
        ...
        <div class="container py-md-5">
            ...
            <div class="row">
                <div class="col-lg-4 gallery-content-info text-center mt-lg-5">
                    <h3 class="title-wthree mb-lg-5 mb-4">Trendler </h3>
                    <p>Modayı Takip Eden Çantalar İçin Doğru Yerdesiniz</p>
                    <a href="shop.php" class="btn shop mt-3">Alışverişe Başla</a>
